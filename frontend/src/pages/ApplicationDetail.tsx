...
export const ApplicationDetail: React.FC = () => {
  ...
  const canWithdraw = (level: 'FACTORY' | 'DIRECTOR' | 'MANAGER' | 'CEO') => {
    ...
    return allowedStatuses[level]?.includes(currentStatus) ?? false
  }
        ...
        <main className="flex-1 p-8">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-2">新建申请功能</p>
              <p className="text-sm text-gray-500 mb-4">请返回申请列表，点击"新建申请"按钮创建新申请</p>
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="mx-6 mt-4">
                ...
                <TabsTrigger value="attachments">附件 ({application.attachments?.length || 0})</TabsTrigger>
              </TabsList>
              ...
              {/* 审批记录标签 */}
              <TabsContent value="approvals" className="px-0">
              ...
              {/* 附件标签 */}
              <TabsContent value="attachments" className="px-0">
