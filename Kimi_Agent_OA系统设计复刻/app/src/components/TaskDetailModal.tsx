...
import { sampleTask, users } from '@/data/mockData';
...
export function TaskDetailModal({ isOpen, onClose }: TaskDetailModalProps) {
  ...
  const [comments, setComments] = useState<Comment[]>(sampleTask.comments);
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
              <h2 className="text-lg font-semibold text-gray-900">{sampleTask.name}</h2>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    {sampleTask.assignees.map((user) => (
                      <Badge
                        key={user.id}
                        variant="secondary"
                        className="flex items-center gap-1 px-2 py-1 bg-blue-50 text-blue-700 hover:bg-blue-100"
                      >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm text-gray-700">{sampleTask.dueDate}</span>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Badge className={`${priorityStyles[sampleTask.priority]}`}>
                    {priorityLabels[sampleTask.priority]}
                  </Badge>
                </div>
              </div>
                ...
                <TabsContent value="comment" className="mt-0">
                  ...
                  <div className="mt-4 flex gap-3">
                    <Avatar className="w-8 h-8 flex-shrink-0">
                      ...
                      <AvatarFallback className="text-xs">{users[0].name.charAt(0)}</AvatarFallback>
                    </Avatar>
                    <div className="flex-1">
                      <Input
                        placeholder="添加评论..."
            ...
            <div className="flex items-center justify-between p-6 border-t border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <div className="flex -space-x-2">
                  {sampleTask.collaborators.map((user) => (
                    <Avatar key={user.id} className="w-7 h-7 border border-white">
                      <AvatarImage src={user.avatar} alt={user.name} />
